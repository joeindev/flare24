...
import dev.flare24.mod.Mod;
import dev.flare24.mod.gui.clickgui.ClickGuiScreen;
import dev.flare24.mod.modules.Module;
import dev.flare24.mod.modules.impl.client.*;
import dev.flare24.mod.modules.impl.combat.*;
import dev.flare24.mod.modules.impl.exploit.*;
import dev.flare24.mod.modules.impl.misc.*;
import dev.flare24.mod.modules.impl.movement.*;
import dev.flare24.mod.modules.impl.player.*;
import dev.flare24.mod.modules.impl.player.freelook.FreeLook;
import dev.flare24.mod.modules.impl.render.*;
import dev.flare24.mod.modules.settings.Setting;
import dev.flare24.mod.modules.settings.impl.BindSetting;
...
public class ModuleManager implements Wrapper {
    ...
    public void render3D(MatrixStack matrixStack) {
        ...
        Flare.EVENT_BUS.post(new Render3DEvent(matrixStack, mc.getTickDelta()));
        matrixStack.pop();
