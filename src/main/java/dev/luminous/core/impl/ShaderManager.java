...
import dev.flare24.api.interfaces.IShaderEffect;
...
public class ShaderManager implements Wrapper {
    ...
    public void setupShader(Shader shader, ManagedShaderEffect effect) {
        dev.flare24.mod.modules.impl.render.Shader shaderChams = dev.flare24.mod.modules.impl.render.Shader.INSTANCE;
