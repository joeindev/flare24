...
import dev.flare24.mod.modules.impl.client.HUD;
import dev.flare24.mod.modules.impl.client.ModuleList;
...
public class ConfigManager extends Manager {
	...
	public static void resetModule() {
		for (Module module : Flare.MODULE.modules) {
	...
	public void loadSettings() {
		for (Module module : Flare.MODULE.modules) {
			...
			module.setState(Flare.CONFIG.getBoolean(module.getName() + "_state", module instanceof HUD || module instanceof ModuleList));
		}
	}
	public void saveSettings() {
		...
		try {
			...
			printwriter.println("prefix:" + Flare.PREFIX);

			for (ClickGuiTab tab : Flare.GUI.tabs) {
				printwriter.println(tab.getTitle() + "_x:" + tab.getX());
				printwriter.println(tab.getTitle() + "_y:" + tab.getY());
			}
			printwriter.println("armor_x:" + Flare.GUI.armorHud.getX());
			printwriter.println("armor_y:" + Flare.GUI.armorHud.getY());
			...
			System.out.println("[" + Flare.NAME + "] Failed to save settings");
		} finally {
	...
	public void readSettings() {
		...
		try {
			...
			System.out.println("[" + Flare.NAME + "] Failed to load settings");
		}
	}
