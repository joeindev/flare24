...
public class Shader extends Module {
    ...
    public boolean shouldRender(Entity entity) {
        ...
        if (entity instanceof PlayerEntity) {
            ...
            if (Flare.FRIEND.isFriend((PlayerEntity) entity))
    ...
    public void onRender3D(MatrixStack matrixStack) {
        if (hands.getValue())
            Flare.SHADER.renderShader(()-> mc.gameRenderer.renderHand(matrixStack, mc.gameRenderer.getCamera(), mc.getTickDelta()), mode.getValue());
    }

    @Override
    public void onToggle() {
        Flare.SHADER.reloadShaders();
    }
