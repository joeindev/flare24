...
public class ClientSetting extends Module {
    ...
    public final StringSetting windowTitle = add(new StringSetting("WindowTitle", Flare.NAME, () -> page.is(Page.Misc)));
    ...
    public final StringSetting hackName = add(new StringSetting("Notification", "[Flare]", () -> page.getValue() == Page.Notification));
