...
import dev.flare24.asm.accessors.IEntityVelocityUpdateS2CPacket;
import dev.flare24.asm.accessors.IExplosionS2CPacket;
...
public class Velocity extends Module {
	...
	public void onVelocity(EntityVelocityUpdateEvent event) {
		...
		if (mode.is(Mode.Grim) || mode.is(Mode.Wall)) {
			...
			boolean insideBlock = Flare.PLAYER.insideBlock;
	...
	public void onUpdate() {
		...
		if (flag) {
			if (lagBackTimer.passed(100) && (flagInWall.getValue() || !Flare.PLAYER.insideBlock)) {
