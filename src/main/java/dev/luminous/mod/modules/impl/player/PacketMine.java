...
import dev.flare24.api.events.impl.ClickBlockEvent;
...
import dev.flare24.api.utils.math.Easing;
...
import dev.flare24.mod.modules.impl.combat.AutoAnchor;
import dev.flare24.mod.modules.impl.combat.AutoCev;
import dev.flare24.mod.modules.impl.combat.AutoCrystal;
import dev.flare24.mod.modules.settings.SwingSide;
import dev.flare24.mod.modules.settings.impl.*;
...
public class PacketMine extends Module {
	...
	public float getDigSpeed(BlockState state, ItemStack itemStack) {
		...
		boolean inWeb = Flare.PLAYER.isInWeb(mc.player) && mc.world.getBlockState(breakPos).getBlock() == Blocks.COBWEB;
