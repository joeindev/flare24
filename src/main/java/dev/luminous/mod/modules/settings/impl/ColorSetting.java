...
import dev.flare24.mod.modules.impl.client.Colors;
...
public class ColorSetting extends Setting {
	...
	public void loadSetting() {
		this.value = new Color(Flare.CONFIG.getInt(this.getLine(), defaultValue.getRGB()), true);
		this.isRainbow = Flare.CONFIG.getBoolean(this.getLine() + "Rainbow");
		if (injectBoolean) {
			this.booleanValue = Flare.CONFIG.getBoolean(this.getLine() + "Boolean", defaultBooleanValue);
		}
	}
}
