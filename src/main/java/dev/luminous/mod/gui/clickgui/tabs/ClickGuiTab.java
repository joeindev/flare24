package dev.flare24.mod.gui.clickgui.tabs;
...
import dev.flare24.mod.gui.clickgui.components.impl.ModuleComponent;
...
public class ClickGuiTab extends Tab {
	...
	public ClickGuiTab(String title, int x, int y) {
		this.title = title;
		this.x = Flare.CONFIG.getInt(title + "_x", x);
		this.y = Flare.CONFIG.getInt(title + "_y", y);
		this.width = 98;
