package dev.flare24.mod.gui.elements;
...
import dev.flare24.mod.gui.clickgui.tabs.Tab;
...
public class ArmorHUD extends Tab {
	...
	public ArmorHUD() {
		this.width = 80;
		this.height = 34;
		this.x = (int) Flare.CONFIG.getFloat("armor_x", 0);
		this.y = (int) Flare.CONFIG.getFloat("armor_y", 200);
	}
